...
| **Calculator-Culichi**   | A simple yet effective calculator application implementing core arithmetic operations, built for practicing JavaScript logic and version control workflows. | JavaScript, HTML, CSS, Git                              | <a href="https://github.com/ByCulichi/Calculator-Culichi" target="_blank"><img src="https://github.com/ByCulichi/Calculator-Culichi/blob/main/calculator.gif" width="120px" alt="Calculator Demo"/></a> | [🔢 View Live](https://calculator-culichi.vercel.app/) |
| **JourneyBlog**          | A personal blogging platform designed to share travel experiences, stories, and adventures. Features a clean and modern interface with responsive design for optimal reading experience across all devices. | JavaScript, HTML, CSS, Responsive Design                | <a href="https://github.com/ByCulichi/JourneyBlog" target="_blank"><img src="https://github.com/ByCulichi/JourneyBlog/blob/main/journeyblog.gif" width="120px" alt="JourneyBlog Demo"/></a> | [✈️ View Live](https://byculichi.github.io/Journey_blog/) |
