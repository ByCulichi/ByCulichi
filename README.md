...
| Project                  | Description                                                                                                                                   | Technologies Used                                       | Demo | Live Link |
|--------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|------|-----------|
| **Mirror (Spotify Culichi)** | A pixel-perfect recreation of Spotify's web player showcasing modern web development practices with authentication, real-time playback, and Spotify Web API integration. Features include music browsing, personalized recommendations, liked songs, and a fully responsive dark theme. | TypeScript, Next.js 14, React, Tailwind CSS, Spotify API | <a href="https://github.com/ByCulichi/Mirror" target="_blank"><img src="https://github.com/user-attachments/assets/a93e1df1-68df-4c89-b41f-9374f1bc43f3" width="120px" alt="Spotify Culichi Demo"/></a> | [🎵 View Live](https://mirror-cyan.vercel.app/) |
| **RonnysPage** | A vibrant retro-styled landing page for Ronny's Food Truck, featuring a modern design with LED-style animations. Showcases menu items, location, and customer reviews for a dessert and snack business in Ecatepec, Mexico. | TypeScript, Next.js, React, Tailwind CSS, Responsive Design | <a href="https://github.com/ByCulichi/RonnysPage" target="_blank"><img src="https://github.com/user-attachments/assets/89cd15cb-7a45-4c30-8955-00a8f8825c32" width="120px" alt="Ronny's Food Truck Demo"/></a> | [🐕 View Live](https://ronnystruck.vercel.app/) |
| **Calculator-Culichi**   | A simple yet effective calculator application implementing core arithmetic operations, built for practicing JavaScript logic and version control workflows. | JavaScript, HTML, CSS, Git                              | <a href="https://github.com/ByCulichi/Calculator-Culichi" target="_blank"> <img src="https://github.com/user-attachments/assets/6114fd21-9761-4dac-b3cc-0dee0dd15ed8" alt="Calculator Demo" width="400"/></a> | [🔢 View Live](https://calculator-culichi.vercel.app/) |
| **JourneyBlog**          | A personal blogging platform designed to share travel experiences, stories, and adventures. Built entirely with HTML, featuring a clean and modern interface with responsive design for optimal reading experience across all devices. | HTML                | <a href="https://github.com/ByCulichi/JourneyBlog" target="_blank"><img src="https://github.com/ByCulichi/JourneyBlog/blob/main/journeyblog.gif" width="120px" alt="JourneyBlog Demo"/></a> | [✈️ View Live](https://byculichi.github.io/Journey_blog/) |
| **Todo-App-Culichi**     | An intuitive task management tool that lets users add, complete, and delete tasks, focusing on user experience and responsive UI design.               | JavaScript, HTML, CSS, Local Storage                    | <a href="https://github.com/ByCulichi/Todo-App-Culichi" target="_blank"><img src="https://github.com/ByCulichi/Todo-App-Culichi/blob/main/Todoapp.gif" width="120px" alt="Todo App Demo"/></a> |[📓 View Live](https://byculichi.github.io/Todo-Culichi/) |
| **Portfolio-Culichi**    | My personal portfolio showcasing my skills, projects, and work experience through a clean and interactive interface.                                   | JavaScript, HTML, CSS, Responsive Design                | <a href="https://github.com/ByCulichi/Portfolio-Culichi" target="_blank"><img src="https://github.com/ByCulichi/Portfolio-Culichi/blob/main/Portfolio.gif" width="120px" alt="Portfolio Demo"/></a> | [📖 View Live](https://byculichi.github.io/Portfolio-Culichi/) |
| **WeatherApp-Culichi**   | A weather application that fetches real-time weather data from a public API, displaying forecasts with a dynamic and user-friendly interface.          | JavaScript, HTML, CSS, REST API, Fetch API              | <a href="https://github.com/ByCulichi/WeatherApp-Culichi" target="_blank"><img src="https://github.com/ByCulichi/WeatherApp-Culichi/blob/main/Weatherapp.gif" width="120px" alt="Weather App Demo"/></a> | [☁️ View Live](https://byculichi.github.io/WeatherApp-Culichi/) |

> ⭐ Check each repository for technical details, documentation, and source code.
> 🚀 Projects with live demos can be explored directly through the links provided!
...
<p align="center">
  ...
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=ByCulichi&layout=compact&theme=dark&langs_count=8&hide=html&include_all_commits=true&count_private=true" alt="Top Langs" />
